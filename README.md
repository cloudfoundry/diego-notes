...
| `i1`: `RUNNING SUSPECT`<br/><br/>`i2`: `CLAIMED ORDINARY` | `cell-1` : `Missing`<br/><br/>`cell-2`: `Present` | `cell-2` calls `StartActualLRP` | `i1`: `REMOVED`<br/>ActualLRPRemovedEvent(Instance: `i1`, Evacuating: `nil`)<br/><br/>ActualLRPInstanceRemovedEvent(Instance: `i1`)<sup>[[1]](#lrp-instance-events)</sup><br/><br/>`i2`: `RUNNING ORDINARY`<br/>ActualLRPCreatedEvent(Instance: `i2`, Evacuating: `nil`)<br/><br/>ActualLRPInstanceChangedEvent(Instance: `i1`, Beforestate: `Claimed`, Afterstate: `Running`)<sup>[[1]](#lrp-instance-events)</sup><br/><br/> | Once `cell-2` starts a replacement ActualLRP, the `SUSPECT` instance can be removed from the missing cell and avoid any routing downtime. |
